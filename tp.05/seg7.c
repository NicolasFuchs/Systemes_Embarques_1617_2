...
void seg7_display_value(int value, bool is_dot)
{
...
void seg7_display_zero()
{
    display[0].seg7 = seg7[0];
    display[0].dot  = DP1;
...
void seg7_display_null()
{
    display[0].seg7 = seg7[16];
    display[0].dot  = 0;
    display[1].seg7 = seg7[16];
    display[1].dot  = 0;
