...
/**
 * Prototype of the thermo event handler
 * @param on true if the alarm is detected, false otherwise
 */
typedef void(*thermo_alarm_eh_t)(bool on);
 ...
 *
 * @param routine alarm event handler
 */
extern void thermo_init(thermo_alarm_eh_t routine);
